...
class AutowiniSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            'https://www.autowini.com/search/cars?conditions=C020&locations=C0830&status=C030&pageSize=30&pageOffset=0',
        ]
    ...
    def parse(self, response, page):
        ...
        if jsn['cars']['resultSet'] != []:
            for car in jsn['cars']['resultSet']:
                ...
                output["seats"] = car['passengerCapacity']
                ######
            ...
            # pagination
            page += 1
            page_link = f'https://www.autowini.com/search/cars?conditions=C020&locations=C0830&status=C030&pageSize=30&pageOffset={page}'
