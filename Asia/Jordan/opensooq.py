...
class OpensooqSpider(scrapy.Spider):
    ...
    def start_requests(self):
        initial_url = 'https://jo.opensooq.com/en/find?PostSearch[categoryId]=1775&PostSearch[subCategoryId]=1777'
    ...
    def parse(self, response):
        ...
        link_list = response.xpath('//a[@class="flex flexNoWrap p-16 blackColor radius-8 grayHoverBg ripple boxShadow2 relative"]/@href').getall()
        link_list = ["https://jo.opensooq.com" + i for i in link_list]
        ...
        if next_button:
            yield response.follow("https://jo.opensooq.com" + next_button, self.parse,
        ...
        for data in form_data:
            ...
            if value is not None:
                ...
                if "Make" in key:
                    ...
                    value = value.replace(",", "")
                    odometer = value.split("-")[-1].strip()
                    output["odometer_value"] = int(odometer)
